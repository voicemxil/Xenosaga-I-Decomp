 ...
 * its L_* macro and includes this header, mirroring how libgcc compiles
 * libgcc2.c once per member -- which is also why the original ELF holds
 * four byte-identical static copies of __clz_tab (0x004D6C20..0x004D6F20),
 * one per TU, each referenced by its own inlined __udivmoddi4.
 * src/longlong.h is the toolchain's own copy, unmodified.
 */
